...
api_path = "/sma/api/v2.0/reporting/mail_sender_ip_hostname_detail?duration=2014-04-23T00:00-00:00/2014-10-21T00:00-00:00&entity=2001::63&starts_with=true"  # param
url = server + api_path
if (url[-1] == '/'):
    url = url[:-1]
